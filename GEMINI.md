...
- **Linting & Formatting:** [Biome](https://biomejs.dev/), ESLint, and Prettier.
...
A shadcn-like CLI for initializing the library and adding components to any Svelte project.

- `svelte-ui init`: Initializes your project with base styles, utilities, and required dependencies.
- `svelte-ui add [component]`: Copies component files (Svelte, CSS, Variants) from the library to your project and adjusts imports.
